export const listaHotel = [
  {
    id: 1,
    title: 'HAVANA-CUBA',
    name: 'El Candid Boutique Hotel',
    description: 'O El Candil Boutique Hotel oferece jardim, lounge compartilhado, terraço e restaurante em Havana. Idealmente situado no bairro de Vedado, este hotel oferece um bar. A acomodação oferece serviço de quarto, concierge e serviço de câmbio.O hotel oferece quartos com ar-condicionado, mesa de trabalho, cofre, TV de tela plana e banheiro privativo com chuveiro. No El Candil Boutique Hotel, os quartos incluem roupa de cama e toalhas. A propriedade serve café da manhã continental diariamente.',
